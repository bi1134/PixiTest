...
export class HistoryPopup extends Container {
  ...
  public resize(width: number, height: number) {
    ...
    this.doneButton.x =
      this.panelBase.width / 2 - this.doneButton.width - padding;
    ...
    this.scrollBox.height =
      this.panelBase.height - this.title.height - padding * 4;

    this.scrollBox.list.x =
      this.scrollBox.width / 2 - this.scrollBox.list.width / 2;
  }
