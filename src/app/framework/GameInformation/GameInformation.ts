...
export class GameInformation extends Container {
    ...
    public resize(width: number, height: number, padding: number, inputContainerY: number, inputContainerHeight: number) {
        ...
        LayoutHelper.scaleToWidth(this.higherMultiplier, this.profitBoard.width * 0.40, true);
        //prediction container
        this.higherMultiplier.x = this.profitBoard.x + this.profitBoard.width / 8;
        this.higherMultiplier.y = this.profitBoard.y + this.profitBoard.height / 2;

        LayoutHelper.scaleToWidth(this.lowerMultiplier, this.profitBoard.width * 0.40, true);
        //prediction container
        this.lowerMultiplier.x = this.profitBoard.x + this.profitBoard.width / 1.65;
        this.lowerMultiplier.y = this.profitBoard.y + this.profitBoard.height / 2;
    }
}
