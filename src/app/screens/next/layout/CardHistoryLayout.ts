...
export class CardHistoryLayout extends Container {
    ...
    public addCardToHistory(value: string, suit: string, action: GuessAction, padding: number = 8, gapMultipler: number = 1, _scrollMutiplier: number = 5) {
        // 1. Create New Item
        ...
        this.list.y = this.cardsHistoryBackground.height / 2 - (item.heightScaled / 2); // Approximate centering
